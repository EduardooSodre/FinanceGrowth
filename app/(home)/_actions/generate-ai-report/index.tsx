...
export const generateAiReport = async ({ month }: GenerateAiReportSchema) => {
  ...
  if (!hasPlatinumPlan) {
    throw new Error("You need a platinum plan to generate Ai reports");
  }
    ...
    messages: [
      {
        role: "system",
        content:
          "Você é um especialista em gestão finanças pessoais. Você ajuda as pessoas a organizarem melhor as suas finanças",
      },
      {
        role: "user",
        content,
  ...
  //pegar o relatório gereado pelo ChatGPT e retornar para o usuário
